<?php
/**
 * Applies database/migration_v8.sql.
 *
...
$sql = file_get_contents(__DIR__ . '/migration_v8.sql');
...
echo "\nMigration v8 complete: {$applied} applied, {$skipped} already present, {$failed} failed.\n";
exit($failed > 0 ? 1 : 0);
