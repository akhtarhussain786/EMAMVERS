<?php
/**
 * Applies database/migration_v6.sql.
 *
...
$sql = file_get_contents(__DIR__ . '/migration_v6.sql');
...
echo "\nMigration v6 complete: {$applied} applied, {$skipped} already present, {$failed} failed.\n";
exit($failed > 0 ? 1 : 0);
