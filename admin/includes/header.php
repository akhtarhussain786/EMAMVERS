...
<header class="top-bar">
    ...
    <div style="display:flex; align-items:center; gap:1.5rem;">
        ...
        <a href="login.php?action=logout" class="btn" style="background:rgba(239, 68, 68, 0.15); color:#fca5a5; font-size:0.8rem; padding:0.4rem 0.8rem; border:1px solid rgba(239,68,68,0.3);">
