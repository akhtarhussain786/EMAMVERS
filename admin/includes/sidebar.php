...
<aside class="sidebar" id="sidebar">
    ...
    <ul class="nav-menu">
        ...
        <li>
            <a href="index.php?page=users" class="nav-link <?php echo $currentPage==='users'?'active':'';?>">
        ...
        <li>
            <a href="index.php?page=map_locations" class="nav-link <?php echo $currentPage==='map_locations'?'active':'';?>">
        ...
        <li>
            <a href="index.php?page=question_review" class="nav-link <?php echo $currentPage==='question_review'?'active':'';?>">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"/></svg>
                Question Review
            </a>
            <a href="index.php?page=question_bank" class="nav-link <?php echo $currentPage==='question_bank'?'active':'';?>">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 7v10m4-10v10m4-10v10m4-10v10m4-10v10M2 21h20M2 7l10-4 10 4"/></svg>
                Bank Health
            </a>
